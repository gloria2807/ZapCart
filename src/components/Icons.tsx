...
export const QrCodeIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg className={`${sizeClasses[size]} ${className}`} viewBox="0 0 24 24" fill="black">
...
export const POSIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
  ...
  >
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 17h.01M12 17h4" />
  </svg>
);

export const SalesIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${sizeClasses[size]} ${className}`}
    fill="none"
    viewBox="0 0 24 24"
...
export const InventoryIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${sizeClasses[size]} ${className}`}
    fill="none"
    viewBox="0 0 24 24"
